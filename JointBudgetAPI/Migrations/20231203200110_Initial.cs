    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeImage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "varchar(450)", unicode: false, maxLength: 450, nullable: false),
                    FamilyGroupId = table.Column<string>(type: "varchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseCategory_ExpenseImage",
                        column: x => x.ImageId,
                        principalTable: "ExpenseImage",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExpenseCategory_User",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomeCategory_IncomeImage",
                        column: x => x.ImageId,
                        principalTable: "IncomeImage",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomeCategory_User",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseCategory_ImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomeCategory_ImageId",
